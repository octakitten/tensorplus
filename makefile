...
$(TARGETDIR)$(TARGET): $(BUILDDIR)$(OBJDIR)$(OBJECTS) $(BUILDDIR)$(OBJDIR)$(CUOBJS)
	$(CC) $(CFLAGS) $(EXTRA_CUDA_FLAGS) $(DEBUGFLAGS) $(LDFLAGS) $(GCCFLAGS) -o $(TARGETDIR)$(TARGET) $(BUILDDIR)$(OBJDIR)$(OBJECTS) $(BUILDDIR)$(OBJDIR)$(CUOBJS) $(FLAGS) 

$(BUILDDIR)$(OBJDIR)$(CUOBJS): $(SOURCEDIR)$(CUSOURCES)
	$(CXX) $(CFLAGS) $(DEBUGFLAGS) $(LDFLAGS) $(GCCFLAGS) $(OBJTARFLAGS) $(CUDAFLAGS) -c $(BUILDDIR)$(OBJDIR)$(CUOBJS) $(SOURCEDIR)$(CUSOURCES) $(FLAGS)

$(BUILDDIR)$(OBJDIR)$(OBJECTS): $(SOURCEDIR)$(SOURCES)
	$(CC) $(CFLAGS) $(EXTRA_CUDA_FLAGS) $(DEBUGFLAGS) $(LDFLAGS) $(GCCFLAGS) $(OBJTARFLAGS) -c $(BUILDDIR)$(OBJDIR)$(OBJECTS) $(SOURCEDIR)$(SOURCES) $(FLAGS)
